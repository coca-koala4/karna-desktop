import { JsonRpcGatewayClient } from '@karna/shared'
...
export class KarnaGateway extends JsonRpcGatewayClient {
  constructor() {
    super({
      closedErrorMessage: 'Karna gateway connection closed',
      connectErrorMessage: 'Could not connect to Karna gateway',
      createRequestId: nextId => nextId,
      notConnectedErrorMessage: 'Karna gateway is not connected',
...
// the call; each pooled backend already has its own KARNA_HOME, so no backend
...
export async function listSessions(
  ...
  const result = await window.karnaDesktop.api<PaginatedSessions>({
...
export function setSessionArchived(id: string, archived: boolean, profile?: string | null): Promise<{ ok: boolean }> {
  return window.karnaDesktop.api<{ ok: boolean }>({
    ...(profile ? { profile } : {}),
...
export function searchSessions(query: string): Promise<SessionSearchResponse> {
  return window.karnaDesktop.api<SessionSearchResponse>({
...
export function getSession(id: string, profile?: string | null): Promise<SessionInfo> {
  ...
  return window.karnaDesktop.api<SessionInfo>({
    ...(profile ? { profile } : {}),
...
export function getSessionMessages(id: string, profile?: string | null): Promise<SessionMessagesResponse> {
  ...
  return window.karnaDesktop.api<SessionMessagesResponse>({
    ...(profile ? { profile } : {}),
...
export function renameSession(
  ...
  return window.karnaDesktop.api<{ ok: boolean; title: string }>({
    ...(profile ? { profile } : {}),
    path: `/api/sessions/${encodeURIComponent(id)}`,
    method: 'PATCH',
...
export function getGlobalModelInfo(): Promise<ModelInfoResponse> {
  return window.karnaDesktop.api<ModelInfoResponse>({
    ...profileScoped(),
    path: '/api/model/info'
  })
}
...
export function getStatus(): Promise<StatusResponse> {
  return window.karnaDesktop.api<StatusResponse>({
    path: '/api/status'
  })
}
...
export function getLogs(params: {
  ...
  return window.karnaDesktop.api<LogsResponse>({
    ...profileScoped(),
    path: suffix ? `/api/logs?${suffix}` : '/api/logs'
  })
}

export function getKarnaConfig(): Promise<KarnaConfig> {
  return window.karnaDesktop.api<KarnaConfig>({
    ...profileScoped(),
    path: '/api/config'
  })
}

export function getKarnaConfigRecord(): Promise<KarnaConfigRecord> {
  return window.karnaDesktop.api<KarnaConfigRecord>({
    ...profileScoped(),
    path: '/api/config'
  })
}

export function getKarnaConfigDefaults(): Promise<KarnaConfigRecord> {
  return window.karnaDesktop.api<KarnaConfigRecord>({
    ...profileScoped(),
...
export function getKarnaConfigSchema(): Promise<ConfigSchemaResponse> {
  return window.karnaDesktop.api<ConfigSchemaResponse>({
    ...profileScoped(),
    path: '/api/config/schema'
  })
}

export function saveKarnaConfig(config: KarnaConfigRecord): Promise<{ ok: boolean }> {
  return window.karnaDesktop.api<{ ok: boolean }>({
    ...profileScoped(),
    path: '/api/config',
    method: 'PUT',
...
export function getMemoryProviderConfig(provider: string): Promise<MemoryProviderConfig> {
  return window.karnaDesktop.api<MemoryProviderConfig>({
...
export function getEnvVars(): Promise<Record<string, EnvVarInfo>> {
  return window.karnaDesktop.api<Record<string, EnvVarInfo>>({
    ...profileScoped(),
    path: '/api/env'
  })
}
...
export function validateProviderCredential(
  ...
  return window.karnaDesktop.api<{ ok: boolean; reachable: boolean; message: string; models?: string[] }>({
    ...profileScoped(),
...
export function revealEnvVar(key: string): Promise<{ key: string; value: string }> {
  return window.karnaDesktop.api<{ key: string; value: string }>({
    ...profileScoped(),
    path: '/api/env/reveal',
    method: 'POST',
    body: { key }
...
export function listOAuthProviders(): Promise<OAuthProvidersResponse> {
  return window.karnaDesktop.api<OAuthProvidersResponse>({
    ...profileScoped(),
...
export function disconnectOAuthProvider(providerId: string): Promise<{ ok: boolean; provider: string }> {
  return window.karnaDesktop.api<{ ok: boolean; provider: string }>({
    ...profileScoped(),
...
export function startOAuthLogin(providerId: string): Promise<OAuthStartResponse> {
  return window.karnaDesktop.api<OAuthStartResponse>({
    ...profileScoped(),
...
export function submitOAuthCode(providerId: string, sessionId: string, code: string): Promise<OAuthSubmitResponse> {
  return window.karnaDesktop.api<OAuthSubmitResponse>({
    ...profileScoped(),
...
export function pollOAuthSession(providerId: string, sessionId: string): Promise<OAuthPollResponse> {
  return window.karnaDesktop.api<OAuthPollResponse>({
    ...profileScoped(),
...
export function getSkills(): Promise<SkillInfo[]> {
  return window.karnaDesktop.api<SkillInfo[]>({
    ...profileScoped(),
    path: '/api/skills'
  })
}
...
export function toggleSkill(name: string, enabled: boolean): Promise<{ ok: boolean; name: string; enabled: boolean }> {
  return window.karnaDesktop.api<{ ok: boolean; name: string; enabled: boolean }>({
    ...profileScoped(),
...
export function getToolsets(): Promise<ToolsetInfo[]> {
  return window.karnaDesktop.api<ToolsetInfo[]>({
    ...profileScoped(),
...
export function getToolsetConfig(name: string): Promise<ToolsetConfig> {
  return window.karnaDesktop.api<ToolsetConfig>({
    ...profileScoped(),
...
export function selectToolsetProvider(
  ...
  return window.karnaDesktop.api<{ ok: boolean; name: string; provider: string }>({
    ...profileScoped(),
...
export function runToolsetPostSetup(name: string, key: string): Promise<ActionResponse & { key: string }> {
  return window.karnaDesktop.api<ActionResponse & { key: string }>({
    ...profileScoped(),
...
export function getMessagingPlatforms(): Promise<MessagingPlatformsResponse> {
  return window.karnaDesktop.api<MessagingPlatformsResponse>({
...
export function updateMessagingPlatform(
  ...
  return window.karnaDesktop.api<{ ok: boolean; platform: string }>({
...
export function testMessagingPlatform(platformId: string): Promise<MessagingPlatformTestResponse> {
  return window.karnaDesktop.api<MessagingPlatformTestResponse>({
...
export function getCronJobs(): Promise<CronJob[]> {
  return window.karnaDesktop.api<CronJob[]>({
    path: '/api/cron/jobs'
  })
}
...
export async function getCronJobRuns(jobId: string, limit = 20): Promise<SessionInfo[]> {
  const { runs } = await window.karnaDesktop.api<{ runs: SessionInfo[] }>({
...
export function getProfiles(): Promise<ProfilesResponse> {
  return window.karnaDesktop.api<ProfilesResponse>({
    path: '/api/profiles'
  })
}

export function createProfile(body: ProfileCreatePayload): Promise<{ name: string; ok: boolean; path: string }> {
  return window.karnaDesktop.api<{ name: string; ok: boolean; path: string }>({
    path: '/api/profiles',
    method: 'POST',
    body
  })
...
export function deleteProfile(name: string): Promise<{ ok: boolean; path: string }> {
  return window.karnaDesktop.api<{ ok: boolean; path: string }>({
    path: `/api/profiles/${encodeURIComponent(name)}`,
    method: 'DELETE'
  })
}
...
export function getProfileSoul(name: string): Promise<ProfileSoul> {
  return window.karnaDesktop.api<ProfileSoul>({
...
export function getProfileSetupCommand(name: string): Promise<ProfileSetupCommand> {
  return window.karnaDesktop.api<ProfileSetupCommand>({
    path: `/api/profiles/${encodeURIComponent(name)}/setup-command`
  })
}

export function getUsageAnalytics(days = 30): Promise<AnalyticsResponse> {
  return window.karnaDesktop.api<AnalyticsResponse>({
    ...profileScoped(),
...
export function getGlobalModelOptions(opts?: { refresh?: boolean }): Promise<ModelOptionsResponse> {
  return window.karnaDesktop.api<ModelOptionsResponse>({
    ...profileScoped(),
    path: opts?.refresh ? '/api/model/options?refresh=1' : '/api/model/options'
  })
}

export function listCustomModels(): Promise<{ models: CustomModelInfo[] }> {
  return window.karnaDesktop.api<{ models: CustomModelInfo[] }>({
    ...profileScoped(),
    path: '/api/model/custom'
  })
}
...
export function saveCustomModel(body: {
  ...
  api_key?: string
  enabled?: boolean
}): Promise<ModelTestResponse & { model?: CustomModelInfo }> {
  return window.karnaDesktop.api<ModelTestResponse & { model?: CustomModelInfo }>({
    ...profileScoped(),
    path: body.id ? `/api/model/custom/${encodeURIComponent(body.id)}` : '/api/model/custom',
    method: body.id ? 'PUT' : 'POST',
    body
  })
}

export function testCustomModel(id: string, body: { api_key?: string } = {}): Promise<ModelTestResponse> {
  return window.karnaDesktop.api<ModelTestResponse>({
    ...profileScoped(),
    path: `/api/model/custom/${encodeURIComponent(id)}/test`,
    method: 'POST',
    body
  })
}

export function deleteCustomModel(id: string): Promise<{ ok: boolean }> {
  return window.karnaDesktop.api<{ ok: boolean }>({
    ...profileScoped(),
    path: `/api/model/custom/${encodeURIComponent(id)}`,
    method: 'DELETE'
  })
}
...
export interface RecommendedDefaultModel {
  provider: string
  model: string
  /** True/false for Karna (free vs paid tier); null for other providers. */
  free_tier: boolean | null
}

// Recommended default model for a freshly-authenticated provider. Mirrors the
// curation `karna model` does — for Karna it honors the free/paid tier so a
// free user gets a free model instead of a paid default.
export function getRecommendedDefaultModel(provider: string): Promise<RecommendedDefaultModel> {
  return window.karnaDesktop.api<RecommendedDefaultModel>({
    ...profileScoped(),
...
export function setGlobalModel(
  ...
  return window.karnaDesktop.api<{ ok: boolean; provider: string; model: string }>({
    ...profileScoped(),
    path: '/api/model/set',
    method: 'POST',
    body: {
...
export function getAuxiliaryModels(): Promise<AuxiliaryModelsResponse> {
  return window.karnaDesktop.api<AuxiliaryModelsResponse>({
    ...profileScoped(),
...
export function setModelAssignment(body: ModelAssignmentRequest): Promise<ModelAssignmentResponse> {
  return window.karnaDesktop.api<ModelAssignmentResponse>({
    ...profileScoped(),
    path: '/api/model/set',
    method: 'POST',
    body
...
export function restartGateway(): Promise<ActionResponse> {
  return window.karnaDesktop.api<ActionResponse>({
    path: '/api/gateway/restart',
    method: 'POST'
  })
}

export function updateKarna(): Promise<ActionResponse> {
  return window.karnaDesktop.api<ActionResponse>({
    path: '/api/karna/update',
    method: 'POST'
  })
}
...
export function checkKarnaUpdate(force = false): Promise<BackendUpdateCheckResponse> {
  return window.karnaDesktop.api<BackendUpdateCheckResponse>({
    path: `/api/karna/update/check${force ? '?force=true' : ''}`
  })
}

export function getActionStatus(name: string, lines = 200): Promise<ActionStatusResponse> {
  return window.karnaDesktop.api<ActionStatusResponse>({
    path: `/api/actions/${encodeURIComponent(name)}/status?lines=${Math.max(1, lines)}`
  })
}

export function transcribeAudio(dataUrl: string, mimeType?: string): Promise<AudioTranscriptionResponse> {
  return window.karnaDesktop.api<AudioTranscriptionResponse>({
...
export function speakText(text: string): Promise<AudioSpeakResponse> {
  return window.karnaDesktop.api<AudioSpeakResponse>({
...
export function getElevenLabsVoices(): Promise<ElevenLabsVoicesResponse> {
  return window.karnaDesktop.api<ElevenLabsVoicesResponse>({
