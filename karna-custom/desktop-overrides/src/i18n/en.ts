...
export const en: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      startingKarnaDesktop: 'Starting Karna Desktop…'
    },
    errors: {
  ...
  settings: {
    ...
    gateway: {
      ...
      envOverrideDesc:
        'Unset KARNA_DESKTOP_REMOTE_URL and KARNA_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /karna.',
    ...
    toolsets: {
      ...
      ready: 'Ready',
      karnaIncluded: 'Included with a Karna subscription — sign in to Karna Portal to activate.',
  ...
  commandCenter: {
    ...
    karnaActiveSessions: (version, count) => `Karna ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@karna:example.org' },
  ...
  install: {
    ...
    settingUpTitle: 'Setting up Karna',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Karna",
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid Karna subscription.',
    free: 'Free',
    freeTier: 'Free tier',
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.karna/config.yaml). Karna won’t ask again for commands like this — in this session or any future one.`,
  ...
  desktop: {
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `karna gateway` running?'
    }
  },
