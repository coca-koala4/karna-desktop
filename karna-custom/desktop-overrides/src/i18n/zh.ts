...
export const zh: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      startingKarnaDesktop: '正在启动 Karna 桌面版…'
    },
    errors: {
  ...
  settings: {
    ...
    gateway: {
      ...
      envOverrideDesc: '取消设置 KARNA_DESKTOP_REMOTE_URL 和 KARNA_DESKTOP_REMOTE_TOKEN 后才会使用下面保存的设置。',
      localTitle: '本地网关',
      ...
      remoteUrlDesc: '远程 dashboard 后端的基础 URL。支持路径前缀，例如 /karna。',
    ...
    toolsets: {
      ...
      ready: '就绪',
      karnaIncluded: '包含在 Karna 订阅中；登录 Karna Portal 即可激活。',
  ...
  commandCenter: {
    ...
    karnaActiveSessions: (version, count) => `Karna ${version} · 活跃会话 ${count}`,
    restartGateway: '重启网关',
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot 用户 ID', placeholder: '@karna:example.org' },
    ...
    platformIntro: {
      ...
      weixin:
        '运行 `karna gateway setup`，选择 Weixin，然后使用个人微信账号扫描并确认二维码。Karna 会通过腾讯 iLink Bot API 连接并保存凭据。',
  ...
  updates: {
    ...
    guiSkewBody: '后端已更新，但此桌面应用包未更改。请更新或重新安装 Karna 桌面应用（你的 AppImage / .deb / .rpm）以保持一致。',
    copy: '复制',
    copied: '已复制',
    done: '完成',
    applyingBody: 'Karna 更新器会在自己的窗口中接管，并在完成后自动重新打开 Karna。更新期间请不要自行重新打开 Karna。',
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro 模型需要付费 Karna 订阅。',
    free: '免费',
    freeTier: '免费层',
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `这会将“${pattern}”模式加入永久允许列表 (~/.karna/config.yaml)。Karna 对类似命令将不再询问，包括当前会话和未来会话。`,
      alwaysAllow: '始终允许'
    },
    clarify: {
      notReady: '澄清请求尚未就绪',
  ...
  desktop: {
    ...
    handoff: {
      ...
      timedOut: '等待网关超时。`karna gateway` 是否正在运行？'
    }
  },
