...
import { getSessionMessages, listAllProfileSessions, listSessions } from './karna'
...
describe('Karna REST session helpers', () => {
  let api: ReturnType<typeof vi.fn>

  beforeEach(() => {
    api = vi.fn().mockResolvedValue(emptySessionsResponse)
    Object.defineProperty(window, 'karnaDesktop', {
      configurable: true,
      value: { api }
    })
  })
  ...
  afterEach(() => {
    vi.restoreAllMocks()
    Reflect.deleteProperty(window, 'karnaDesktop')
  })
