...
export const en: Translations = {
  ...
  boot: {
    ready: 'Karna Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Karna settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Karna Desktop…'
    },
    errors: {
      backgroundExited: 'Karna background process exited.',
      backgroundExitedDuringStartup: 'Karna background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Karna backend is older than this desktop build and may not work correctly. Update to align them.',
    updateHermes: 'Update Karna',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Karna Desktop.',
    ...
    native: {
      ...
      inputBody: 'Karna is waiting for your response.',
      turnDoneTitle: 'Karna finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Karna defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Karna is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Karna asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Karna was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Karna follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Karna is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Karna, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Karna checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Karna configuration...',
    ...
    gateway: {
      ...
      intro:
        'Karna Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Karna backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private Karna backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Karna backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'Karna Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Karna ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Karna runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  starmap: {
    ...
    emptyDesc: 'As Karna builds skills and memories for your work, they appear here.',
    share: 'Share map',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Karna to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Karna to generate pets.',
      backgroundHint: 'You can close this — Karna will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Karna desktop' },
    ...
    hermesActiveSessions: (version, count) => `Karna ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Karna environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Karna will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Karna backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Karna. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Karna...',
    placeholderReconnecting: 'Reconnecting to Karna…',
    ...
    attachUrlDesc: 'Karna will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Karna to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Karna…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Karna…',
    ...
    unsupportedMessage: 'This version of Karna can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Karna is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Karna backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Karna from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Karna will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Karna desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Karna updater takes over in its own window and reopens Karna automatically when it’s done. Please don’t reopen Karna yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Karna reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Karna reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Karna needs a one-time install',
    ...
    settingUpTitle: 'Setting up Karna Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Karna CLI or desktop instance is running. Stop any running Karna instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Karna installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Karna Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Karna is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Karna…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Karna',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Karna at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Karna connects automatically',
      loopback: 'Opens your browser to sign in — Karna connects automatically',
    ...
    authorizeThere: 'Authorize Karna there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Karna there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Karna Desktop v${version}`,
      ...
      gatewayTitle: 'Karna inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Karna will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Karna is restarting...',
      askRestart: 'Ask Karna to restart the server',
      lookingRestart: taskId => `Karna is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Karna is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Karna finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Karna could not restart the server.',
      stillWorking:
        'Karna is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Karna is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Karna gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Karna won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Karna needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Karna needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Karna Desktop to use Save Image.',
    restartToSaveImages: 'Restart Karna Desktop to save images',
