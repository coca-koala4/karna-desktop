 ...
 *
 * A public install can end up with `origin=git@github.com:123abcbjs/karna-desktop.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/123abcbjs/karna-desktop.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/123abcbjs/karna-desktop'
