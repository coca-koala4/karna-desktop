...
$RepoUrlSsh = "git@github.com:123abcbjs/karna-desktop.git"
$RepoUrlHttps = "https://github.com/123abcbjs/karna-desktop.git"
$PythonVersion = "3.11"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/123abcbjs/karna-desktop/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/123abcbjs/karna-desktop/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/123abcbjs/karna-desktop/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
